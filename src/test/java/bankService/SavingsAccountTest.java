...
public class SavingsAccountTest {
    ...
    public void withdrawingAmountGreaterThanBalance_Throws_InsufficientFundsException() throws InsufficientFundsException {
        ...
        try {
            ...
            fail("Expected Insufficient Funds Exception but none was throw");//Esto lo que lanza una exepecuon "AssertionError", si no fue lanzada ninguna en la linea anterior
            //
